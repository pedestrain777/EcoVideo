...
<table border="0" style="width: 100%; text-align: center; margin-top: 20px;">
  <tr>
    <td>
      <video src="https://github.com/user-attachments/assets/17c44777-d4a7-4d18-90e8-480d4c753a4b" width="100%" controls autoplay loop></video>
    </td>
    <td>
      <video src="https://github.com/user-attachments/assets/21600aee-11f5-44d0-8f07-a734a18c3503" width="100%" controls autoplay loop></video>
    </td>
    <td>
      <video src="https://github.com/user-attachments/assets/6e3419df-700f-41d6-80c3-8b48a895724c" width="100%" controls autoplay loop></video>
    </td>
  </tr>
  <tr>
    <td><em>"A beautiful coastal beach in spring, waves lapping on sand, in super slow motion"</em></td>
    <td><em>"A bigfoot walking in the snowstorm."</em></td>
    <td><em>"A person is skydiving"</em></td>
  </tr>
  <tr>
    <td>
      <video src="https://github.com/user-attachments/assets/2d087a57-2239-400e-a2ad-254f87071039" width="100%" controls autoplay loop></video>
    </td>
    <td>
      <video src="https://github.com/user-attachments/assets/644526ee-5b7c-43ee-be1b-4335b7418dab" width="100%" controls autoplay loop></video>
    </td>
    <td>
      <video src="https://github.com/user-attachments/assets/2ef737fa-ac04-4258-99cd-393478f3044c" width="100%" controls autoplay loop></video>
    </td>
  </tr>
  <tr>
    <td><em>"Close up of grapes on a rotating table."</em></td>
    <td><em>"a shark is swimming in the ocean, pan left"</em></td>
    <td><em>"A panda drinking coffee in a cafe in Paris, pan left"</em></td>
  </tr>
</table>
